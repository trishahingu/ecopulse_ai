...
export const Icons = {
  ...
  Leaf: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 3.5 2 5.5s-4 4.5-5 5c.7 2.1-.2 2.3-.9 3.5-1 1.7-1.1 4-1.1 4Z"/><path d="M11 20s-1-2-6-10c0 0 4-1 6 2"/><path d="M11 20a7 7 0 0 0 7-7"/></svg>
  ),
  Alert: () => (
